...
Если данной производительности всё еще будет не хватать можно просмотры скидывать в очередь,
и записывать в БД пачками, так можно распределить нагрузку во времени, отображение в реальном времени 
кол-во просмотров не в приоритете.